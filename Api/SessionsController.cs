...
namespace ehrmadesimple.Api
{
    ...
    public class SessionsController : ControllerBase
    {
        ...
        // GET: api/Sessions/5
        [HttpGet("{id}")]
        public async Task<ActionResult<IEnumerable<Session>>> GetSessionsByClient(string id)
        {
            if(id == null) {
                return NotFound();
            }
            ...
            return await _context.Sessions
                        .FromSqlRaw($"SELECT * FROM Sessions WHERE ClientId='{id}'")
                        .ToListAsync();
        }
        ...
        public async Task<ActionResult<Session>> PostSession(Session session)
        {
            ...
            return CreatedAtAction("GetSession", new { id = session.RowNumber }, session);
        }
